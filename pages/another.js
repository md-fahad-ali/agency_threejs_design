        ...
        <div className="col-12">
          ...
          >
            {data.map((e, i) => (
              <div
                key={i}
                className="w-[90%] sm:w-[80%] md:w-[90%] lg:w-[80vmax] custom-card h-[90%] sm:h-auto md:h-auto lg:h-[80%] rounded-3xl flex-col-reverse md:flex-row-reverse shadow flex justify-center items-center content-center transition-all bg-zinc-700 absolute"
                style={{ zIndex: `${i + 2}` }}
              >
                <div className="flex h-full justify-center items-center">
                  <Image
                    ...
                    className="w-[95%] h-[90%] sm:h-[80%] sm:w-[37vmax] md:h-[90%] rounded-3xl pb-[10px] sm:pb-0"
                    width={500}
                    height={500}
                  />
                </div>
                <div className="p-5 w-full md:w-[50%] transition-all">
                  <h5
                    className={`${montserrat.className} mb-2 lg:text-6xl md:text-4xl text-3xl flex-row sm:flex-col tracking-tight text-gray-900 dark:text-white`}
                  >
                    {e.title}
                  </h5>
                  <p>{e.description}</p>
