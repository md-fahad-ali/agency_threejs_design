...
export default function Card({ title, targetScale, progress, description, image, tags, i, range }) {
    ...
    return (
        ...
        <div ref={container} className="h-screen sticky top-0 flex flex-col justify-center items-center" >
            <motion.div className="flex flex-col semi:flex-row-reverse bg-zinc-700 w-[90%] sm:h-[80%] rounded-[30px] ss:rounded-[50px] items-center justify-between pl-[10px] semi:pr-[30px] pr-[10px] relative" style={{ top: getTopStyle(i), scale: scale, boxShadow: "0px 0px 9px 0px #18181b" }}>
